...
class MTTMPembagianScreen extends StatefulWidget {
  final int A, B;
  final double width;
  ...
  _MTTMPembagianScreen createState() => _MTTMPembagianScreen();
}

class _MTTMPembagianScreen extends State<MTTMPembagianScreen> {
