...
class MTTMPenjumlahanScreen extends StatefulWidget {
  final int A, B;
  final double width;

  MTTMPenjumlahanScreen({
    required this.A,
    required this.B,
    required this.width,
  });

  _MTTMPenjumlahanScreen createState() => _MTTMPenjumlahanScreen();
}

class _MTTMPenjumlahanScreen extends State<MTTMPenjumlahanScreen> {
